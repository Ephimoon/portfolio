            ...
            <div className="max-w-screen-xl mx-auto w-full">
                <motion.div
                    ...
                    <div className="flex items-center justify-center w-full md:w-1/3 p-4">
                        <img src="/linkedinphoto.JPEG" alt="Melanie Escobar Marulanda" className="max-h-[15vh] sm:max-h-[25vh] md:max-h-[45vh] lg:max-h-[60vh] w-auto h-auto object-contain rounded-2xl shadow-lg" />
                    </div>
