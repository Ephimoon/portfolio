...
const AboutMe = () => {
    ...
    return (
        <section id="aboutme" className="relative min-h-screen snap-start w-full bg-white flex items-center">
                ...
                <motion.div
                    ...
                    <div className='h-2/3 md:h-full md:w-2/3 flex flex-col justify-center items-center p-10 gap-5 font-gaegu font-bold text-second'>
                        ...
                        <div className="flex gap-4 mt-4">
                            <a href="/cert.pdf" className="flex items-center justify-center px-3 py-2 text-sm font-medium bg-accent border-2 border-third text-third rounded-xl hover:bg-third hover:text-white transition-transform duration-200 hover:scale-105">
                                resume
                            </a>

                            <button
                                onClick={() => window.open('https://github.com/Ephimoon', '_blank')}
                                className="items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium transition-transform duration-200 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group relative animate-rainbow cursor-pointer border-0 bg-[linear-gradient(#fff,#fff),linear-gradient(#fff_50%,rgba(255,255,255,0.6)_80%,rgba(0,0,0,0)),linear-gradient(90deg,hsl(0,100%,63%),hsl(90,100%,63%),hsl(210,100%,63%),hsl(195,100%,63%),hsl(270,100%,63%))] bg-[length:200%] text-foreground [background-clip:padding-box,border-box,border-box] [background-origin:border-box] [border:calc(0.08*1rem)_solid_transparent] before:absolute before:bottom-[-20%] before:left-1/2 before:z-[0] before:h-[20%] before:w-[60%] before:-translate-x-1/2 before:animate-rainbow before:bg-[linear-gradient(90deg,hsl(0,100%,63%),hsl(90,100%,63%),hsl(210,100%,63%),hsl(195,100%,63%),hsl(270,100%,63%))] before:[filter:blur(calc(0.8*1rem))] dark:bg-[linear-gradient(#121213,#121213),linear-gradient(#121213_50%,rgba(18,18,19,0.6)_80%,rgba(18,18,19,0)),linear-gradient(90deg,hsl(0,100%,63%),hsl(90,100%,63%),hsl(210,100%,63%),hsl(195,100%,63%),hsl(270,100%,63%))] hover:scale-105 active:scale-95 h-10 px-4 py-2 inline-flex"
                                >
